# This Makefile is for the CGI::Application::Plugin::Routes extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/CGI/Application/Plugin/Routes.pm]
#     AUTHOR => q[Julián Porta <julian.porta@gmail.com>]
#     NAME => q[CGI::Application::Plugin::Routes]
#     PL_FILES => {  }
#     PREREQ_PM => { Test::More=>q[0] }
#     VERSION_FROM => q[lib/CGI/Application/Plugin/Routes.pm]
#     clean => { FILES=>q[CGI-Application-Plugin-Routes-*] }
...
NAME_SYM = CGI_Application_Plugin_Routes
VERSION = 0.01
...
MAKE = make
FULLEXT = CGI/Application/Plugin/Routes
BASEEXT = Routes
...
TO_INST_PM = TestApp.pm \
	lib/CGI/Application/Plugin/Routes.pm

PM_TO_BLIB = lib/CGI/Application/Plugin/Routes.pm \
	blib/lib/CGI/Application/Plugin/Routes.pm \
	TestApp.pm \
	$(INST_LIB)/CGI/Application/Plugin/TestApp.pm
...
DISTNAME = CGI-Application-Plugin-Routes
DISTVNAME = CGI-Application-Plugin-Routes-0.01
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/CGI/Application/Plugin/Routes.pm $(INST_MAN3DIR)/CGI::Application::Plugin::Routes.$(MAN3EXT) \
	  TestApp.pm $(INST_MAN3DIR)/CGI::Application::Plugin::TestApp.$(MAN3EXT) 
...
clean :: clean_subdirs
	- $(RM_F) \
	  ...
	  *$(OBJ_EXT) pm_to_blib \
	  ...
	  $(BASEEXT).exp 
	- $(RM_RF) \
	  CGI-Application-Plugin-Routes-* blib 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:                CGI-Application-Plugin-Routes' >> META_new.yml
	$(NOECHO) $(ECHO) 'version:             0.01' >> META_new.yml
	$(NOECHO) $(ECHO) 'abstract:            CGI::Application::Plugin::Routes' >> META_new.yml
	$(NOECHO) $(ECHO) 'license:             ~' >> META_new.yml
	$(NOECHO) $(ECHO) 'author:              ' >> META_new.yml
	$(NOECHO) $(ECHO) '    - Julián Porta <julian.porta@gmail.com>' >> META_new.yml
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>CGI::Application::Plugin::Routes</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Julián Porta &lt;julian.porta@gmail.com&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' -- \
	  lib/CGI/Application/Plugin/Routes.pm blib/lib/CGI/Application/Plugin/Routes.pm \
	  TestApp.pm $(INST_LIB)/CGI/Application/Plugin/TestApp.pm 
